...
while running:
    if game_state == AppConfig.STORY:
        ...
        hibernation_mode_title = Label(story_frame, anchor=SE, text="", background="#000000", foreground="#ffffff")
        ...
        # sound1= Button(window,text="play sound",font=('Impact', -30),command=play)
        # sound1.pack(pady=20)
        # sound1.place(x=473, y = 550)
        # time.sleep(10)
