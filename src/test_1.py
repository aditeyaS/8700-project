...
while running:
    if game_state == AppConfig.STORY:
        story_frame = Frame(window, height=1000, width=1000, bg="#000000")
        ...
        textAbout = " \n\n\n\nYou are the Halloween hunter \n\nPlease enter you username to start the game"
        game_description = Label(story_frame, anchor=SE, text=textAbout, background="#000000", foreground="#ffffff",padx=175, pady=40,font=('Impact', -30))
        game_description.place(y=50)
        
        hibernation_mode_title = Label(story_frame, anchor=SE, text="Hibernation Mode", background="#000000", foreground="#ffffff")
        hibernation_mode_title.place(x=700/2, y=100)

        hibernation_text = "\n\n\n\n\n\nYou are the Halloween hunter \n\nPlease enter your username to start the game"
        game_description = Label(story_frame, anchor=SE, text=hibernation_text, background="#000000", foreground="#ffffff",padx=175, pady=20,font=('Impact', -30))
        game_description.place(y=50)

        # story_canvas = Canvas(window, width=AppConfig.WINDOW_WIDTH, height=AppConfig.WINDOW_HEIGHT)

        username_input = Entry(story_frame)
        username_input.insert(0, "Enter your name here")
        username_input.place(x=400, y = 500)

        border = LabelFrame(window, bd = 6, bg = "white")
        border.pack(pady = 10)
        ...
        start_button.place(x=443, y = 550)
